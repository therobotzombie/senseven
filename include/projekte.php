    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            <ul class="cbp-rfgrid">
                ...
                <li>
                	<a data-toggle="modal" data-target="#project-frohwein"><img src="img/project_frohwein.jpg" /><div><h3>Daniel Frohwein</h3></div></a>
                </li>
                <li>
                ...
                <li>
                	<a data-toggle="modal" data-target="#project-wang"><img src="img/project_wang.jpg" /><div><h3>Robin Wang</h3></div></a>
                </li>  
                <li>
                ...
                <li>
                	<a data-toggle="modal" data-target="#project-rapp"><img src="img/project_rapp.jpg" /><div><h3>Padraic Rapp</h3></div></a>
                </li>
                <li>
                	<a data-toggle="modal" data-target="#project-woods"><img src="img/project_woods.jpg" /><div><h3>Jessica Woods</h3></div></a>
                </li>        
                <li>
                	<a data-toggle="modal" data-target="#project-schmidt"><img src="img/project_schmidt.jpg" /><div><h3>Patrizia Schmidt</h3></div></a>
                </li>        
            </ul>
        </div>
    </div>
