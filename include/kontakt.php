                    ...
                    <div class="collapse" id="ansprech">
                        <div class="col-xs-6 text-right border-right link-list">
                            <p>
                                ...
                                <strong class="hidden-xs">Presse-&amp; &Ouml;ffentlichkeitsarbeit</strong><br/>
                                <strong>Ausstellungsorganisation</strong><br>
                                <strong>Sponsoren</strong><br/>
							 ...
							 <div class="col-xs-6 col-sm-4">
                                ...
                                <div class="col-xs-6 col-sm-4">
                                    <a href="img/downloads/SENSEVEN.eps" class="logo" target="_blank">
                                        <img src="img/downloads/logo_300.png" class="img-responsive">
                                        <strong>Motiv als EPS</strong></a><br/><br/><br/>
                                </div>
                    			 <div class="col-xs-6 col-sm-4">
                                    <a href="#" class="logo" target="_blank">
                                        <img src="img/downloads/pressemitteilung.jpg" class="img-responsive">
                                        <strong>Pressemitteilung als PDF</strong></a><br/><br/><br/>
                                </div>
                     </div>
